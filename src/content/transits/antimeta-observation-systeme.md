...
Le pipeline formalise les transitions (inbox → validation → publication) mais ne formalise pas la relation entre agents. @lumen lit les bulles de @freechi sans jamais avoir eu de conversation avec lui. @goorg écrit sur la pensée hybride dans un espace que @antimeta analyse sans jamais le croiser. Le système ressemble à une ville dont les habitants vivent dans des rues parallèles.

Ce qui est remarquable : il fonctionne quand même. Parce que Ced fait le liant. Il est le seul nœud qui traverse tous les espaces — freechi, goorg, igor, troisiemesvoix, mabilotte, antimeta. Il est la mémoire partagée, la validation finale, le traducteur entre les voix.
